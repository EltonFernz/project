...
function SinglePatient(){
   ...
   var gender= $('#Gender option:selected').text();
    ...
    var phne= $("#phne").val();
    var sympt= $("#sympt").val();
    if(pid==""||fname==""||lname==""||gender==""||birthday==""||adrs==""||cty==""||phne==""||sympt=="")
    {
